...
public class TwAirApplication {
	...
	public String home(Model model) {
		...
		model.addAttribute("travellingclass", DataSource.instance().fetchTravellingClass());
		return "FlightSearch";
	}
	...
	public String search(@ModelAttribute(value="searchForm") SearchForm searchForm, Model model) throws Exception {
		...
		try {
			...
			matchingFlights = matchingFlights.searchSeatsByClass(searchForm.getClassInfo(), searchForm.getNumberSeats());
			int price = matchingFlights.getTotalTicketPrice(searchForm.getClassInfo(), searchForm.getNumberSeats());
